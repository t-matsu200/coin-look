            ...
            <div>
              ...
              <div className={styles.table_block}>
                <table>
                  ...
                  <tr>
                    <th>特徴</th>
                    <td>・スマートコントラクト<br/>・創業メンバーは、ソニー株式会社の第7代社長の安藤氏を筆頭に元ソニーのメンバー<br/>・Jasmy IoT Platformを使ったIoT開発環境・ブロックチェーンデータ分析が利用可能になり、個人情報の一元管理、運用が実現できるエコシステム<br/>・Jリーグ「サガン鳥栖」の公式スポンサー</td>
                  </tr>
                </table>
              </div>
            </div>
